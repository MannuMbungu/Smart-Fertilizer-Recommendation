...
const FERTILIZER_ENDPOINT = 'http://127.0.0.1:5080/fertilizer_recommend'
...
export function FertilizerPage() {
    ...
    return (
        <>
            ...
            <p className="fertilizer-p"> Enter soil characteristics, Soil Nutrient leves & crop you are growing to find best <b> FERTILIZER </b> for your farm 👩‍🌾🌽🚜 </p>
